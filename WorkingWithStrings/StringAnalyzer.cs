...
namespace WorkingWithStrings
{
    ...
    internal class StringAnalyzer
    {
        ...
        public List<NumberAndWordPair> WordAndCountNumbers()
        {
            ...
            var arrStr = _str.Split(" ", StringSplitOptions.RemoveEmptyEntries);
        ...
        public List<string> QuestionSentences()
        {
            ...
            {
                if(CheckSentenceSeparators(_str[i]))
                {
                    var result = _str.Substring(lastPosition, (i-lastPosition)+1);
                    lastPosition = i+1;
        ...
        public List<string> SentencesWithoutCommas()
        {
            ...
            string[] AllSentences = _str.Split(new[] { '.', '!', '?' }, StringSplitOptions.RemoveEmptyEntries);
        ...
        public List<string> FindWordsWithSameStartEndLetter()
        {
            ...
            string[] words = _str.Split(" ", StringSplitOptions.RemoveEmptyEntries);
